...
<%--				<li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>--%>
		...
		<div id="show-imagem" class="content scaffold-show" role="main">
			...
			<ol class="property-list imagem">
				...
				<g:if test="${imagemInstance?.recurso?.condominio}">
				<li class="fieldcontain">
					<span id="condominio-label" class="property-label"><g:message code="recurso.condominio.label" default="Nome do condomínio" /></span>
						...
						<span class="property-value" aria-labelledby="condominio-label"><g:link controller="condominio" action="show" id="${imagemInstance?.recurso?.condominio?.id}">${imagemInstance?.recurso?.condominio?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="imagem-label"><img class="imagem-show" src="${createLink(controller:'imagem', action:'imagem', id:imagemInstance.id)}" /></span>
