...
<html>
	...
	<body>
		<a href="#list-convidado" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="convidado.reserva.label" default="Reserva" /></th>
				...
				<g:each in="${convidadoInstanceList}" status="i" var="convidadoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${convidadoInstance.id}">${fieldValue(bean: convidadoInstance, field: "nome")}</g:link></td>
					
						<td>${fieldValue(bean: convidadoInstance, field: "cpf")}</td>
					
						<td>${fieldValue(bean: convidadoInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: convidadoInstance, field: "reserva")}</td>
